  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="env-svg" style={{ overflow: "visible" }}>
      ...
      <text x={MX} y={MY+6} textAnchor="middle"
        ...
        style={{ filter: "drop-shadow(0 1px 3px rgba(0,0,0,.6))" }}>S♡J</text>

      {/* postmark */}
      <g opacity="0.45" transform={`translate(${W-56}, 10)`}>
        <circle cx="16" cy="16" r="14" fill="none" stroke="#3A5050" strokeWidth="1.5" />
        <text x="16" y="11" textAnchor="middle" fontFamily="'Josefin Sans',sans-serif" fontSize="4.5" fill="#3A5050" letterSpacing="1" fontWeight="300">COMO</text>
        <text x="16" y="17" textAnchor="middle" fontFamily="'Josefin Sans',sans-serif" fontSize="4.5" fill="#3A5050" letterSpacing="1" fontWeight="300">ITALY</text>
        <text x="16" y="23" textAnchor="middle" fontFamily="'Josefin Sans',sans-serif" fontSize="4.5" fill="#3A5050" letterSpacing="1" fontWeight="300">2026</text>
...
function PhotoFrame({ label, icon }) {
  return (
...
export default function WeddingInvitation() {
  ...
  const handleClick = () => {
    ...
    setShowMsg(true);
    setTimeout(() => { setShowMsg(false); spawnHearts(setHearts); }, 2500);
        ...
        <div className="full-inner">
          <div className="full-card">
            ...
            <div className="fs">
              ...
              <div className="cover-names">Sophia<span className="cover-amp">&amp;</span>James</div>
            ...
            <div className="couple-photos">
              <PhotoFrame label="Add photo here" icon="🌿" />
              <PhotoFrame label="Add photo here" icon="🌿" />
            </div>
            ...
            <div className="fs">
              ...
              <div className="det-grid">
                {[
                  {i:"📍",l:"Venue",    v:"Villa Bellariva\nCernobbio, Como"},
                  {i:"📅",l:"Date",     v:"Saturday\n14 June 2026"},
                  {i:"⏰",l:"Ceremony", v:"4:30 PM\nReception follows"},
                  {i:"🏨",l:"Hotel",    v:"Grand Hotel Tremezzo\nGroup rate avail."},
                ].map(d => (
